 ...
 * 
 * <p>2014  (version 2.3)
 * The SLView object defined in SLView.main() was changed from "adv" to "main" so that copying
 * code from the class (the code is typically used to prototype the view) to Main.main() does
 * not require refactoring due to having two variables, "adv" and "main".
 * 
...
//======================= test program for this class =======================
	...
	/**
	 * A demo program that just displays the GUI.  Do not use this method as the main() for a project that
	 * uses the MVC library.  Consider defining the main() method in another class, such as Main.
	 */
	public static void main(String[] args)
	{
		...
		//        recall that SLModel and SLController cannot be used; a subclass for each must be defined.
		...
		// Students may edit this code when designing a prototype for a new project.  After editing, students
		// should copy the final code from below into the main() method that is used for the project.
		
		System.out.println(version);		// This is optional

		SLView view = new SLView("Virtual Computer", 20, 20,40,20);   // use something like 1, 20 for a row of boxes
		view.setTextArea("The model's output.\n\n");				  // how to write to the view's text area.
		...
		// The next lines write short strings to the grid.  You can even change the color of the text.
		view.setGridButtonText("X", 0, 2);
		view.setGridButtonText("O", 2, 5);
		view.setGridButtonForeground(Color.RED, 2, 5);
